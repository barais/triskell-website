    ...
    $(this).each(function () {
      ...
      // ..if not, let's initialize.
        ...
        settings = $.extend({
          ...
          imageSize: 32,       // Size of image in pixels
          refresh:   false,
          timeLinks: true,
          replies:   true,
          retweets:  true,
          ...
          renderTweet: function (tweet) {
            ...
            if (this.settings.showAuthor) {
              ...
              if (typeof tweet.retweeter_screen_name!='undefined') {
                ...
                html += '<span class="username">original tweet by <a href="' + tweet.retweeter_profile_url + '" rel="external">' + tweet.retweeter_screen_name + '</a></span> ';                                              
              } else {
                html += '<span class="triangle"></span>';
